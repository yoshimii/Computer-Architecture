...
* Make a list of files here.
  -ls8.py file: loads the program to the cpu then runs it
  -cpu.py file: CPU class with read, write, load (program), trace (for debugging), and the alu function which stores all operations (such as 'ADD' and 'LDI')
  -examples folder: contains ls8 programs as lines of comments and binary coded numbers and instructions
